...
- [Chat with a terminal using pegwings-go](/examples/terminal-chat)
- [Document VHDL files using pegwings-go](/examples/vhdl-documentor-json)
- [Execute generated python code using Toolhouse and pegwings-go](/examples/toolhouse-python-code-interpreter)
